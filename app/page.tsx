...
import styles from "./RetroGameStyles.module.css"
  ...
  topics: [
    {
      ...
      description:
        "Provides a review of basic C constructs to familiarize readers with syntax and concepts that will be used to write programs.",
      subtopics: [
    ...
    },
    {
      ...
      description:
        "Introduction to data structures and algorithms, covering time complexity and performance evaluation of algorithms.",
      subtopics: [
...

    {
      ...
      title: "Arrays",
      description:
        "Detailed explanation of one-dimensional, two-dimensional, and multi-dimensional arrays, including operations performed on them.",
      subtopics: [
    ...
    },
    {
      ...
      title: "Strings",
      description:
        "Introduction to strings (character arrays), including operations such as reading, writing, and manipulating them.",
      subtopics: [
    ...
    },
    {
      ...
      description:
        "Covers the use of structures and unions for organizing data of different types, and their applications in advanced data structures.",
      subtopics: [
    ...
    },
    {
      ...
      description:
        "An introduction to dynamic programming and its applications in solving complex problems efficiently.",
      subtopics: [
    ...
    },
    {
      ...
      title: "Backtracking",
      description:
        "Understanding backtracking algorithms and their applications in solving problems with multiple solutions.",
      subtopics: [
...
const Page = () => {
  ...
  const fetchQuestions = async () => {
    if (selectedSubtopic !== null) {
      const subtopic = courseStructure.topics
        .find((chapter) => chapter.id === selectedTopic)
        ?.subtopics.find((sub) => sub.id === selectedSubtopic)

      if (subtopic) {
        try {
          const apiKey = "AIzaSyCyoasSyFVFvbh_wCZX6U6QAiq57nJqbOA"
          const genAI = new GoogleGenerativeAI(apiKey)
          const model = genAI.getGenerativeModel({ model: "gemini-pro" })
          const prompt = "Explain " + subtopic.title
  ...
  return (
    <div className={styles.retroContainer}>
      <h1 className={styles.retroTitle}>Data Structures and Algorithms Quest</h1>

      <div className={styles.selectWrapper}>
        <label className={styles.retroLabel}>
          Select a Topic:
          <select onChange={handleTopicChange} defaultValue="" className={styles.retroSelect}>
      ...
      {selectedTopic !== null && (
        <div className={styles.selectWrapper}>
          <label className={styles.retroLabel}>
            Select a Subtopic:
            <select onChange={handleSubtopicChange} defaultValue="" className={styles.retroSelect}>
              <option value="" disabled>
                Select a subtopic
              </option>
      ...
      <div className={styles.buttonWrapper}>
        <button onClick={fetchQuestions} disabled={selectedSubtopic === null} className={styles.retroButton}>
          Ask Questions
        </button>
      </div>
      ...
      {questions.length > 0 && (
        <div className={styles.questionsWrapper}>
          <h2 className={styles.retroSubtitle}>Questions:</h2>
          <ul className={styles.retroList}>
            {questions.map((question, index) => (
              <li key={index} className={styles.retroListItem}>
                {question}
              </li>
            ))}
          </ul>
